export const translations = {
    ...
    es: {
        ...
        disclaimerText1: "Los materiales en este convertidor de divisas se proporcionan sin garantías, expresas o implícitas, y por la presente rechaza todas las demás garantías incluyendo sin limitación, garantías implícitas o condiciones de comerciabilidad, o no violación de propiedad intelectual u otra violación de derechos.",
        ...
        ourMissionText: "Creemos que los cálculos deben ser simples, precisos y accesibles para todos nuestra misión es proporcionar información de tipos de cambio en tiempo real y servicios de cálculo que ayuden a individuos y empresas a tomar decisiones financieras informadas nos enfocamos en las divisas que más importan a nuestros usuarios, asegurando que siempre tengas acceso a los tipos de cambio más actuales y precisos",
        ...
        responsiveDesignText: "Optimizado para todos los dispositivos - escritorio, tableta y móvil - para que puedas convertir divisas dondequiera que estés.",
        ...
        realTimeApisDescription: "Para tipos de cambio precisos y actualizados",
        ...
        additionalCurrencies: "Soporte para divisas adicionales",
        historicalCharts: "Gráficos históricos de tipos de cambio",
        currencyAlerts: "Alertas y notificaciones de divisas",
    ...
    fr: {
        ...
        exchangeRateApisText: "Obtenez des taux de change en temps réel depuis InfoDolar.com.do avec plusieurs options de données.",
        ...
        rateLimitUnauth: "10 demandes par minute",
        authenticatedRequests: "Demandes authentifiées",
        rateLimitAuth: "100 demandes par minute",
        ...
        reverseEngineer: "Tenter de faire de l'ingénierie inverse de tout logiciel contenu sur le site web",
        removeCopyright: "Supprimer tout copyright ou autres notations de propriété des matériaux",
        disclaimer: "Avertissement",
        disclaimerText1: "Les matériaux sur ce convertisseur de devises sont fournis sans aucune garantie, expresse ou implicite, et par les présentes rejette toutes les autres garanties, y compris sans limitation, les garanties implicites ou conditions de commercialisation, ou non-violation de la propriété intellectuelle ou autre violation des droits.",
        ...
        governingLawText: "Ces termes et conditions sont régis et interprétés conformément aux lois de la République dominicaine et vous vous soumettez irrévocablement à la juridiction exclusive des tribunaux de cet état ou lieu.",
        ...
        googleAdsense: "Google AdSense et services tiers",
        googleAdsenseText: "Notre site web affiche des publicités par le biais de services tiers. Ce service peut:",
        ...
        ourTechnologyText: "Cette plateforme est construite en utilisant des technologies web modernes pour garantir des performances rapides et fiables:",
        ...
        privacyTitle: "Politique de confidentialité | Convertissez des devises instantanément. Rapide, sûr et toujours précis.",
    ...
    pt: {
        ...
        exchangeRateApisText: "Obtenha taxas de câmbio em tempo real do InfoDolar.com.do com várias opções de dados.",
        ...
        rateLimitUnauth: "10 solicitações por minuto",
        authenticatedRequests: "Solicitações autenticadas",
        rateLimitAuth: "100 solicitações por minuto",
        ...
        limitationsText: "Não somos responsáveis por quaisquer danos decorrentes do uso ou da impossibilidade de usar os materiais neste site, mesmo que nós ou um representante autorizado tenham sido notificados oralmente ou por escrito da possibilidade de tal dano.",
        ...
        realTimeExchangeRatesText: "Nossa plataforma fornece taxas de câmbio atualizadas obtidas de provedores de dados financeiros confiáveis, garantindo precisão para suas necessidades de cálculo.",
