// Auto-extracted from CurrencyConverter fallback data
export function getHardcodedRates(): Record<string, number> {
        return {
            "USD": 1,
...
export type FallbackCurrency = { code: string; name: string; symbol: string; flag: string };

export function getHardcodedCurrencies(): FallbackCurrency[] {
        return [
