...
// Function to get hardcoded rates as fallback (updated with your latest rates)
function getHardcodedRates(): Record<string, number> {
    return {
        "USD": 1,
        "EUR": 1.16169,
        "CAD": 0.714945,
...
export async function GET() {
    try {
        ...
        // Later, this will try to get data from Netlify Blobs first
        ...
        console.error('Error in /api/cached-rates:', error);
        return NextResponse.json({
            success: false,
            error: error instanceof Error ? error.message : 'Unknown error',
            message: 'Failed to get cached rates',
            timestamp: new Date().toISOString(),
            // Fallback to hardcoded rates and currencies even on error
            rates: getHardcodedRates(),
            currencies: getHardcodedCurrencies(),
